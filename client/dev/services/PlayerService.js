...
var PlayerService = (function () {
    ...
    PlayerService.prototype.add = function (player) {
        var _messageStringified = JSON.stringify(player);
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this._http
            .post(PlayerService.ENDPOINT.replace(':id', ''), _messageStringified, { headers: headers })
            .map(function (r) { return r.json(); });
    };
    ...
    PlayerService.ENDPOINT = '/api/players/:id';
